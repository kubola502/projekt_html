...
<body>
    <div class="tlo">
        <div class="content">
            ...
            <p>Zarezerwuj samochód i ruszaj w drogę!</p>
                <div class="guzik">
    ...
    <div class="ustawienie_prostokatow">
        ...
        <div class="prostokaty">
            ...
            <p>Teraz potwierdzamy rezerwację i przygotowujemy Twój samochód. Daj nam chwilę – właśnie dokładamy wszelkich starań, aby każdy detal zachwycał Cię swoją perfekcją przez całą podróż.
             Powinieneś otrzymać wiadomość e-mail z informacją o zatwierdzeniu rezerwacji.</p>
        </div>
        <div class="prostokaty"> 
            ...
            <p>Wszystko gotowe. Wsiadaj i jedź, dokąd tylko pragniesz. Delektuj się tym doświadczeniem – jest niepowtarzalne.</p>
        </div>
    </div>
</div>
    <div class="dol">
        <footer>2024 Wypozyczalnia Aut. Wszelkie prawa zastrzeżone</footer>
    </div>
</body>
</html>